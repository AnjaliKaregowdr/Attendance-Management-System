   ...
   <div align="center"> 
    <form action=" " method="post">
        ...
        <div class="form-group alert alert-dismissible alert-danger">
            <input type="text" name="name" placeholder="Enter student Rollno" class="form-control" required></div></div>
        <br><br>
        <div class="col-md-6 col-md-offset-3 col-lg-6 no-column-padding">
        <div class="form-group alert alert-dismissible alert-danger">
            <input type="text" name="rollno" placeholder="Enter Subject id" class="form-control" required></div></div><br><br>
