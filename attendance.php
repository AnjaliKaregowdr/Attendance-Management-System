...
INNER JOIN user_subject WHERE user_subject.id = subject.id AND user_subject.uid = {$_SESSION['uid']}";
			...
			<table class="table table-striped table-hover">
				...
				<?php
					...
					$qu = "SELECT student.sid, student.name, student.rollno from student INNER JOIN student_subject WHERE student.rollno = student_subject.rollno AND student_subject.id  = {$_GET['subject']}  ORDER BY student.sid";
					$stu=$conn->query($qu);
